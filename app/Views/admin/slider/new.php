...
<section class="uk-section">
    <div class="uk-container min-height">
        ...
        <div class="uk-margin-large-bottom">
            <h3><?= App\Engine\Libraries\Languages::translate('trans.add_slide') ?></h3>
        ...
        <form enctype="multipart/form-data" action="<?= baseUrl("slider") ?>" class="uk-child-width-1-1 uk-grid-match" method="POST" uk-grid>
            <?= csrf_field() ?>
            ...
            <div class="uk-width-2-3@m">
                ...
                <input id="fg-product-category-thumbnail-hidden" type="hidden" name="slide" value="<?= getForm('slide') ?>">
            ...
            <div class="uk-width-1-3@m">
                ...
                <div id="fg-product-category-thumbnail-preview" class="uk-border-rounded uk-position-relative uk-overflow-hidden" style="border: 1px dashed #e5e5e5; height: 110px">
                    ...
                    <?= img(['src' => getForm('slide') ?? 'some.png', 'class' => 'uk-object-cover uk-width-1-1'], true) ?>
                </div>
            </div>

...
<section class="uk-section">
    <div class="uk-container min-height">
        ...
        <div class="uk-margin-large-bottom">
            <h3><?= App\Engine\Libraries\Languages::translate('trans.edit_product_category') ?></h3>
        ...
        <form enctype="multipart/form-data" action="<?= baseUrl("productcategory/{$category->id}") ?>" class="uk-child-width-1-1 uk-grid-match" method="POST" uk-grid>
            <?= setMethod('put') ?>
            
            <div class="uk-width-1-1">
                <label for="" class="uk-form-label"><?= App\Engine\Libraries\Languages::translate('trans.title') ?></label>
                <input type="text" name="title" class="uk-input uk-border-rounded" value="<?= $category->title ?>">
            ...
            <div>
                ...
                <textarea name="description" class="uk-textarea uk-border-rounded"><?= $category->description ?></textarea>
            ...
            <div>
                ...
                <select name="lang" id="" class="uk-select uk-border-rounded">
                    ...
                    <option <?= $lng->code == $category->lang ? 'selected' : '' ?> value="<?= $lng->code ?>"><?= ucfirst($lng->language) ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="uk-width-2-3@m">
                ...
                <input id="fg-product-category-thumbnail-hidden" type="hidden" name="banner" value="<?= $category->banner ?>">
            ...
            <div class="uk-width-1-3@m">
                ...
                <div id="fg-product-category-thumbnail-preview" class="uk-border-rounded uk-position-relative uk-overflow-hidden" style="border: 1px dashed #e5e5e5; height: 110px">
                    ...
                    <?= img(['src' => $category->banner, 'class' => 'uk-object-cover uk-width-1-1'], true) ?>
                </div>
            </div>
